        ...
        <div className="modal-content">
          <form onSubmit={handleSubmit}>
            <div className="modal-header">
              <h5 className="modal-title">Add/Edit Lead</h5>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="requirement" placeholder="required" value={form.requirement} onChange={handleChange} />
                  </div>
                  <div className="mb-3">
